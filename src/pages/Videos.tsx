      ...
      <Card className="border-dashed p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="text-fg-muted text-[13.5px] leading-relaxed text-pretty">
            ...
            посилання, а транскрипт візьми з самого YouTube: розгорни опис під відео — у самому низу
            є «Показати текстову версію». Переклад зробиться автоматично, рядки прив’яжуться до
            часу, кожне слово можна буде натиснути.
          </div>
        </div>
      </Card>
    </div>
